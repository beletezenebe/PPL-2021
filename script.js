...
function copyContentit(text2){
    ...
    try {
       ...
       document.getElementById("no").innerText = text2 +" is coped to your clipboard";

setTimeout(function(){
    document.getElementById("no").innerText = 258 - document.querySelectorAll('.hide').length;
}, 2000);
    } catch (err) {
...
if(element.innerHTML == 0 ){
    document.getElementById("noitem").innerText="No Item Is found" 
}
else{
...
data=[
  ...
  },
  {
    ...
    users = data.map(user => {
      ...
      device_copy.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-clipboard btn text-primary" onclick="copyContentit('${user.device}')" viewBox="0 0 16 16">
      ...
      `
      device_search.innerHTML = `<div class="dropdown">
      <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
        search
      </button>
      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
        <li><a class="dropdown-item" href="https://www.alibaba.com/trade/search?tab=all&searchText=${user.device}">Alibaba</a></li>
        <li><a class="dropdown-item" href="https://www.amazon.com/s?k=${user.device}">Amazon</a></li>
